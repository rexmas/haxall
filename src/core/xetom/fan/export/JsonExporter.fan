...
//////////////////////////////////////////////////////////////////////////
  ...
  ** Spec type
  private This specType(Spec spec)
  {
    ...
    // Effective metadata carries narrowed slot constraints, but downstream
    // consumers still need each declaration link to reconstruct inheritance.
    // Keep the established declared JSON projection unchanged.
    if (isEffective && spec.base != null && !spec.base.isType)
